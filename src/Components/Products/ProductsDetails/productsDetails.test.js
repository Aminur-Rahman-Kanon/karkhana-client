...
import { mockProducts } from "../ProductsList/mockProductsData/mockProductsData";

window.scrollTo = jest.fn();

describe('should productsDetails render correctly', () => {
    test('should productsDetails render with product featured', async () => {
        ...
        expect(productDetails.getByText('৳5000')).toBeInTheDocument();
