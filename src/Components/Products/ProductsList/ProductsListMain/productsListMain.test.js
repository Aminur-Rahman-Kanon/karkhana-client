...
describe('<ProductsListMain />', () => {
    ...
    test('should render productsList component with product latest', async () => {
        ...
        expect(productsList.getByRole('link', { name: 'Latest 1 Add To Cart Latest 1 ৳1200' })).toHaveAttribute('href', '/products/latest/Latest 1');
    ...
    test('should render productsList component with product finger ring', async () => {
        ...
        //checking for individual product link and details
        expect(productsList.getByRole('link', { name: 'Finger Ring 1 Add To Cart Finger Ring 1 ৳1200' })).toHaveAttribute('href', '/products/fingerring/Finger Ring 1');
    ...
    test('should render productsList component with product ear ring', async () => {
        ...
        //checking for individual product link and details
        expect(productsList.getByRole('link', { name: 'Ear Ring 1 Add To Cart Ear Ring 1 ৳1200' })).toHaveAttribute('href', '/products/earring/Ear Ring 1');
    ...
    test('should render productsList component with product necklace', async () => {
        ...
        //checking for individual product link and details
        expect(productsList.getByRole('link', { name: 'Necklace 1 Add To Cart Necklace 1 ৳1200' })).toHaveAttribute('href', '/products/necklace/Necklace 1');
    ...
    test('should render productsList component with product toe ring', async () => {
        ...
        //checking for individual product link and details
        expect(productsList.getByRole('link', { name: 'Toe Ring 1 Add To Cart Toe Ring 1 ৳1200' })).toHaveAttribute('href', '/products/toering/Toe Ring 1');
    ...
    test('should render productsList component with product nepali', async () => {
        ...
        //checking for individual product link and details
        expect(productsList.getByRole('link', { name: 'Nepali 1 Add To Cart Nepali 1 ৳5000' })).toHaveAttribute('href', '/products/nepali/Nepali 1');
    ...
    test('should render productsList component with product other', async () => {
        ...
        //checking for individual product link and details
        expect(productsList.getByRole('link', { name: 'Other 1 Add To Cart Other 1 ৳1200' })).toHaveAttribute('href', '/products/other/Other 1');
    ...
    test('should render productsList component with product featured', async () => {
        ...
        //checking for individual product link and details
        expect(productsList.getByRole('link', { name: 'Featured 1 Add To Cart Featured 1 ৳5000' })).toHaveAttribute('href', '/products/featured/Featured 1');
