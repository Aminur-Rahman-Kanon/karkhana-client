    ...
    if (featuredProducts.length) {
        displayFeaturedProducts = featuredProducts.slice(0, 6).map(products => {
            return <div key={products._id} className={styles.featuredProductsItem}>
                <a href={`http://localhost:3000/featured/${products.name}`} className={styles.featuredProductLink}>
                    <div className={styles.productsImgContainer}>
                ...
                <div className={styles.productDetails}>
                    <a href={`http://localhost:3000/featured/${products.name}`} className={styles.productsName}>{products.name}</a>
