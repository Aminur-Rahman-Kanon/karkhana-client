    ...
    <div className={styles.aboutUsMain}>
        <div className={styles.aboutUsHeaderContainer}>
            <div className={styles.aboutUsHeaderBg}>
                <img src={ header } alt="karkhana" className={styles.aboutUsHeaderBgImg}/>
            </div>
        ...
        <div className={styles.middlePartContainer}>
            ...
            <div className={styles.middlePartImgContainer}>
                <img src={admin} alt="karkhana" className={styles.middlePartImg} />
            </div>
        </div>
            ...
            <div className={styles.teamMemberContainer}>
                    ...
                    <div className={styles.teamMemberImgContainer}>
                        <div className={styles.outerDiv}>
                            <div className={styles.imgContainer}>
                                <img src={team1} alt="karkhana" className={styles.teamImg}/>
                    ...
                    <div className={styles.teamMemberImgContainer}>
                        <div className={styles.outerDiv}>
                            <div className={`${styles.imgContainer} ${styles.item2}`}>
                                <img src={team2} alt="karkhana" className={styles.teamImg}/>
                ...
                <div className={styles.teamMember}>
                    <div className={styles.teamMemberImgContainer}>
                        <div className={styles.outerDiv}>
                            <div className={styles.imgContainer}>
                                <img src={team3} alt="karkhana" className={styles.teamImg}/>
